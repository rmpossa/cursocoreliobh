...
COPY --from=BUILD_BINARIO /home/codigo/target/cartao-credito-0.0.1-SNAPSHOT.jar /home/binarios
...
CMD ["sh", "-c", "java -jar -Dserver.port=8083 ./cartao-credito-0.0.1-SNAPSHOT.jar --spring.profiles.active=docker"]