...
COPY --from=BUILD_BINARIO /home/codigo/target/homebanking-server-0.0.1-SNAPSHOT.jar /home/binarios
...
CMD ["sh", "-c", "java -jar -Dserver.port=8081 ./homebanking-server-0.0.1-SNAPSHOT.jar --spring.profiles.active=docker"]
